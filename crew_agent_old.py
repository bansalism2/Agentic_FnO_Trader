...
if __name__ == "__main__":
    ...
    # Task 1: Portfolio Position Review and Corrective Actions
    ...
    # Task 2: Market Analysis (after portfolio cleanup)
    ...
    # Task 3: Risk Assessment and Available Capital
    ...
    # Task 4: New Strategy Evaluation (Trade Only If Exceptional)
    strategy_execution_task = Task(
        ...
        1. **First, determine if trading is advisable:**
        ...
        2. **If trading conditions are NOT favorable, explicitly state:**
        ...
        3. **Only if exceptional SHORT-TERM opportunities exist:**
        ...
        4. **F&O Trading Standards (ALL must be met):**
        ...
        **IMPORTANT - Data Interval Limits:**
        ...
        expected_output="Trade evaluation report with clear recommendation to either EXECUTE (with detailed rationale) or WAIT (with specific conditions to monitor). Default should be to recommend waiting unless exceptional opportunity exists.",
        context=[portfolio_review_task, market_analysis_task, risk_assessment_task]
    )
    
    # Create and run the crew with F&O optimized settings
    trading_crew = Crew(
